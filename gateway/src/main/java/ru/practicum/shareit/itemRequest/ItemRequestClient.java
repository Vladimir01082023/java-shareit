...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> post(ItemRequestReceiveDto itemRequestReceiveDto, Long userId) {
        return post("", userId, itemRequestReceiveDto);
    }
    ...
    public ResponseEntity<Object> getAll(Long userId, Pageable pageable) {
