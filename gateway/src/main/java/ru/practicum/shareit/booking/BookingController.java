...
public class BookingController {
    ...
    public ResponseEntity<Object> getAllBookingForUser(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        log.info("Get booking for user with state {}, userId={}, from={}, size={}", state, userId, from, size);
        return bookingClient.getAllBookingForUser(userId, state, from, size);
    }

    @PostMapping
    public ResponseEntity<Object> bookItem(@RequestHeader("X-Sharer-User-Id") Long userId,
                                           @RequestBody @Validated BookItemRequestDto bookItemRequestDto) {
        log.info("Creating booking {}, userId={}", bookItemRequestDto, userId);
        return bookingClient.bookItem(bookItemRequestDto, userId);
    }
